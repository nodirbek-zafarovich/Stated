    ...
    return (
        ...
        >
            ...
            <div
                className={`${
                    switcher
                        ? "bg-[--dark] border-[--dark-bg] text-white"
                        : "bg-white"
                } min-h-[93vh]  container mx-auto px-[20px] sm:px-[30px] md:px-[50px] lg:px-[100px]`}
            >
                <button className={`flex gap-2 items-center py-[70px]`}>
                    <span
                        onClick={() => navigated(`/`)}
                        className={`${
                            switcher
                                ? " border-[--dark-bg] text-white"
                                : "bg-white"
                        } border flex items-center gap-2 py-1 px-6  rounded-md`}
                    >
                        <FaArrowLeftLong />
                        <span>Back</span>
                    </span>
